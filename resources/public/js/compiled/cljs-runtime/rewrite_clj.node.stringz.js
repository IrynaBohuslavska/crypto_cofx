...
(rewrite_clj.node.stringz.StringNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4474__auto__,k41306,else__4475__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k41306,else__4475__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4495__auto__,p__41318){
var vec__41320 = p__41318;
var k__4496__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41320,(0),null);
var v__4497__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41320,(1),null);
...
(rewrite_clj.node.stringz.StringNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__41305){
var self__ = this;
var G__41305__$1 = this;
return (new cljs.core.RecordIter((0),G__41305__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"lines","lines",-700165781)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.stringz.StringNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this41307,other41308){
var self__ = this;
var this41307__$1 = this;
return (((!((other41308 == null)))) && ((((this41307__$1.constructor === other41308.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this41307__$1.lines,other41308.lines)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this41307__$1.__extmap,other41308.__extmap)))))));
}));
...
(rewrite_clj.node.stringz.StringNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__4479__auto__,k41306){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k41306);

}
}));

(rewrite_clj.node.stringz.StringNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4480__auto__,k__4481__auto__,G__41305){
var self__ = this;
var this__4480__auto____$1 = this;
var pred__41342 = cljs.core.keyword_identical_QMARK_;
var expr__41343 = k__4481__auto__;
if(cljs.core.truth_((pred__41342.cljs$core$IFn$_invoke$arity$2 ? pred__41342.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"lines","lines",-700165781),expr__41343) : pred__41342.call(null,new cljs.core.Keyword(null,"lines","lines",-700165781),expr__41343)))){
return (new rewrite_clj.node.stringz.StringNode(G__41305,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.stringz.StringNode(self__.lines,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4481__auto__,G__41305),null));
}
}));
...
(rewrite_clj.node.stringz.StringNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4471__auto__,G__41305){
var self__ = this;
var this__4471__auto____$1 = this;
return (new rewrite_clj.node.stringz.StringNode(self__.lines,G__41305,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.stringz.map__GT_StringNode = (function rewrite_clj$node$stringz$map__GT_StringNode(G__41309){
var extmap__4512__auto__ = (function (){var G__41345 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__41309,new cljs.core.Keyword(null,"lines","lines",-700165781));
if(cljs.core.record_QMARK_(G__41309)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__41345);
} else {
return G__41345;
}
})();
return (new rewrite_clj.node.stringz.StringNode(new cljs.core.Keyword(null,"lines","lines",-700165781).cljs$core$IFn$_invoke$arity$1(G__41309),null,cljs.core.not_empty(extmap__4512__auto__),null));
});
