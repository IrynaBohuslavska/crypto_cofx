...
var vec__38030 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(name_str,/-/);
...
var start = first__38032;
var parts = seq__38031__$1;
...
var vec__38033 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(name_str__$1,/-/);
...
var self__ = this;
var self__ = this;
var G__38038 = (arguments.length - (1));
switch (G__38038) {
case (0):
...
(reagent.impl.util.PartialFn.prototype.apply = (function (self__,args38037){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args38037)));
}));
...
var len__4829__auto___38067 = arguments.length;
var i__4830__auto___38068 = (0);
while(true){
if((i__4830__auto___38068 < len__4829__auto___38067)){
args_arr__4850__auto__.push((arguments[i__4830__auto___38068]));

var G__38069 = (i__4830__auto___38068 + (1));
i__4830__auto___38068 = G__38069;
continue;
} else {
}
break;
...
/** @this {Function} */
(reagent.impl.util.class_names.cljs$lang$applyTo = (function (seq38044){
var G__38045 = cljs.core.first(seq38044);
var seq38044__$1 = cljs.core.next(seq38044);
var G__38046 = cljs.core.first(seq38044__$1);
var seq38044__$2 = cljs.core.next(seq38044__$1);
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__38045,G__38046,seq38044__$2);
}));
...
default:
var args_arr__4850__auto__ = [];
var len__4829__auto___38075 = arguments.length;
var i__4830__auto___38076 = (0);
while(true){
if((i__4830__auto___38076 < len__4829__auto___38075)){
args_arr__4850__auto__.push((arguments[i__4830__auto___38076]));

var G__38077 = (i__4830__auto___38076 + (1));
i__4830__auto___38076 = G__38077;
continue;
} else {
}
break;
...
/** @this {Function} */
(reagent.impl.util.merge_props.cljs$lang$applyTo = (function (seq38049){
...
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__38050,G__38051,seq38049__$2);
}));
...
var _STAR_always_update_STAR__orig_val__38053 = reagent.impl.util._STAR_always_update_STAR_;
var _STAR_always_update_STAR__temp_val__38054 = true;
(reagent.impl.util._STAR_always_update_STAR_ = _STAR_always_update_STAR__temp_val__38054);

try{return comp.forceUpdate();
}finally {(reagent.impl.util._STAR_always_update_STAR_ = _STAR_always_update_STAR__orig_val__38053);
}} else {
...
if((i < len)){
var k = (ks[i]);
var G__38084 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),goog.object.get(o,k));
var G__38085 = (i + (1));
m = G__38084;
i = G__38085;
continue;
...
var G__38056 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(v,(0),null);
...
break;
case "r>":
var G__38057 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(v,(2),null);
if((G__38057 == null)){
return null;
} else {
return G__38057.key;
...
var G__38059 = n;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("",G__38059)){
return x;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__38059)){
return x;
} else {
...
var len__4829__auto___38089 = arguments.length;
var i__4830__auto___38090 = (0);
while(true){
if((i__4830__auto___38090 < len__4829__auto___38089)){
args__4835__auto__.push((arguments[i__4830__auto___38090]));

var G__38092 = (i__4830__auto___38090 + (1));
i__4830__auto___38090 = G__38092;
continue;
} else {
}
break;
...
/** @this {Function} */
(reagent.impl.util.hiccup_err.cljs$lang$applyTo = (function (seq38060){
...
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__38061,G__38062,seq38060__$2);
}));
