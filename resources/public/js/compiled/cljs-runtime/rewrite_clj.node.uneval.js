...
(rewrite_clj.node.uneval.UnevalNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4474__auto__,k41312,else__4475__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k41312,else__4475__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4495__auto__,p__41326){
var vec__41327 = p__41326;
var k__4496__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41327,(0),null);
var v__4497__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41327,(1),null);
...
(rewrite_clj.node.uneval.UnevalNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__41311){
var self__ = this;
var G__41311__$1 = this;
return (new cljs.core.RecordIter((0),G__41311__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.uneval.UnevalNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this41313,other41314){
var self__ = this;
var this41313__$1 = this;
return (((!((other41314 == null)))) && ((((this41313__$1.constructor === other41314.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this41313__$1.children,other41314.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this41313__$1.__extmap,other41314.__extmap)))))));
}));
...
(rewrite_clj.node.uneval.UnevalNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__4479__auto__,k41312){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k41312);

}
}));

(rewrite_clj.node.uneval.UnevalNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4480__auto__,k__4481__auto__,G__41311){
var self__ = this;
var this__4480__auto____$1 = this;
var pred__41358 = cljs.core.keyword_identical_QMARK_;
var expr__41359 = k__4481__auto__;
if(cljs.core.truth_((pred__41358.cljs$core$IFn$_invoke$arity$2 ? pred__41358.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__41359) : pred__41358.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__41359)))){
return (new rewrite_clj.node.uneval.UnevalNode(G__41311,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.uneval.UnevalNode(self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4481__auto__,G__41311),null));
}
}));
...
(rewrite_clj.node.uneval.UnevalNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4471__auto__,G__41311){
var self__ = this;
var this__4471__auto____$1 = this;
return (new rewrite_clj.node.uneval.UnevalNode(self__.children,G__41311,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.uneval.map__GT_UnevalNode = (function rewrite_clj$node$uneval$map__GT_UnevalNode(G__41316){
var extmap__4512__auto__ = (function (){var G__41365 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__41316,new cljs.core.Keyword(null,"children","children",-940561982));
...
return (new rewrite_clj.node.uneval.UnevalNode(new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__41316),null,cljs.core.not_empty(extmap__4512__auto__),null));
});
...
var G__41389 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__41389;
continue;
}
break;
