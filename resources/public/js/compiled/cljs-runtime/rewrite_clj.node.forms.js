...
(rewrite_clj.node.forms.FormsNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4474__auto__,k40936,else__4475__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k40936,else__4475__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4495__auto__,p__40971){
var vec__40973 = p__40971;
var k__4496__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40973,(0),null);
var v__4497__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40973,(1),null);
...
(rewrite_clj.node.forms.FormsNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__40935){
var self__ = this;
var G__40935__$1 = this;
return (new cljs.core.RecordIter((0),G__40935__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.forms.FormsNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this40937,other40938){
var self__ = this;
var this40937__$1 = this;
return (((!((other40938 == null)))) && ((((this40937__$1.constructor === other40938.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this40937__$1.children,other40938.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this40937__$1.__extmap,other40938.__extmap)))))));
}));
...
(rewrite_clj.node.forms.FormsNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__4479__auto__,k40936){
var self__ = this;
...
(rewrite_clj.node.forms.FormsNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4480__auto__,k__4481__auto__,G__40935){
var self__ = this;
var this__4480__auto____$1 = this;
var pred__41043 = cljs.core.keyword_identical_QMARK_;
var expr__41044 = k__4481__auto__;
if(cljs.core.truth_((pred__41043.cljs$core$IFn$_invoke$arity$2 ? pred__41043.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__41044) : pred__41043.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__41044)))){
return (new rewrite_clj.node.forms.FormsNode(G__40935,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.forms.FormsNode(self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4481__auto__,G__40935),null));
}
}));
...
(rewrite_clj.node.forms.FormsNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4471__auto__,G__40935){
var self__ = this;
var this__4471__auto____$1 = this;
return (new rewrite_clj.node.forms.FormsNode(self__.children,G__40935,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.forms.map__GT_FormsNode = (function rewrite_clj$node$forms$map__GT_FormsNode(G__40943){
var extmap__4512__auto__ = (function (){var G__41063 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__40943,new cljs.core.Keyword(null,"children","children",-940561982));
...
return (new rewrite_clj.node.forms.FormsNode(new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__40943),null,cljs.core.not_empty(extmap__4512__auto__),null));
});
