...
if((c === "\n")){
var G__42135 = escape_QMARK_;
var G__42136 = rewrite_clj.parser.string.flush_into(lines,buf);
escape_QMARK_ = G__42135;
lines = G__42136;
continue;
} else {
buf.append(c);

var G__42137 = ((cljs.core.not(escape_QMARK_)) && ((c === "\\")));
var G__42138 = lines;
escape_QMARK_ = G__42137;
lines = G__42138;
continue;
...
var G__42125 = rewrite_clj.parser.string.read_string_data(reader);
return (rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1(G__42125) : rewrite_clj.node.string_node.call(null,G__42125));
});
...
var G__42131 = cljs.core.re_pattern(regex);
var G__42132 = ["#\"",regex,"\""].join('');
return (rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2(G__42131,G__42132) : rewrite_clj.node.token_node.call(null,G__42131,G__42132));
});
