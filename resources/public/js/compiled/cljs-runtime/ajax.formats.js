...
var G__50591 = request;
var G__50592 = cljs.core.second(format_entry);
return (ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2 ? ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2(G__50591,G__50592) : ajax.formats.get_format.call(null,G__50591,G__50592));
} else {
...
return cljs.core.some((function (p1__50598_SHARP_){
return ajax.formats.content_type_matches(content_type,p1__50598_SHARP_);
}),accept);
});
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__50601){
var map__50602 = p__50601;
var map__50602__$1 = cljs.core.__destructure_map(map__50602);
var request = map__50602__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50602__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__50605 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__50605.cljs$core$IFn$_invoke$arity$1 ? fexpr__50605.cljs$core$IFn$_invoke$arity$1(response) : fexpr__50605.call(null,response));
});
});
ajax.formats.accept_header = (function ajax$formats$accept_header(p__50607){
var map__50608 = p__50607;
var map__50608__$1 = cljs.core.__destructure_map(map__50608);
var request = map__50608__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50608__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
return cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__50606_SHARP_){
return ajax.formats.get_accept_entries(request,p1__50606_SHARP_);
