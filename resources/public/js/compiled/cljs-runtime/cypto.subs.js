goog.provide('cypto.subs');
re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword("cypto.subs","name","cypto.subs/name",782873093),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (db){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(db);
})], 0));
re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword("cypto.subs","loading","cypto.subs/loading",-1949066553),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (db){
