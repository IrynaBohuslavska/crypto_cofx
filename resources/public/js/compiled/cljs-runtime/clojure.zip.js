...
var G__42188 = clojure.zip.node(loc);
var fexpr__42187 = new cljs.core.Keyword("zip","branch?","zip/branch?",-998880862).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__42187.cljs$core$IFn$_invoke$arity$1 ? fexpr__42187.cljs$core$IFn$_invoke$arity$1(G__42188) : fexpr__42187.call(null,G__42188));
});
/**
...
var G__42190 = clojure.zip.node(loc);
var fexpr__42189 = new cljs.core.Keyword("zip","children","zip/children",-940194589).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__42189.cljs$core$IFn$_invoke$arity$1 ? fexpr__42189.cljs$core$IFn$_invoke$arity$1(G__42190) : fexpr__42189.call(null,G__42190));
} else {
...
var fexpr__42191 = new cljs.core.Keyword("zip","make-node","zip/make-node",1103800591).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__42191.cljs$core$IFn$_invoke$arity$2 ? fexpr__42191.cljs$core$IFn$_invoke$arity$2(node,children) : fexpr__42191.call(null,node,children));
});
/**
...
if(cljs.core.truth_(clojure.zip.branch_QMARK_(loc))){
var vec__42192 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42192,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42192,(1),null);
var vec__42195 = clojure.zip.children(loc);
...
var vec__42198 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42198,(0),null);
var map__42201 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42198,(1),null);
var map__42201__$1 = cljs.core.__destructure_map(map__42201);
var path = map__42201__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42201__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42201__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42201__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42201__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var changed_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42201__$1,new cljs.core.Keyword(null,"changed?","changed?",-437828330));
...
var vec__42202 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42202,(0),null);
var map__42205 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42202,(1),null);
var map__42205__$1 = cljs.core.__destructure_map(map__42205);
var path = map__42205__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42205__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var vec__42206 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42205__$1,new cljs.core.Keyword(null,"r","r",-471384190));
...
var vec__42209 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42209,(0),null);
var map__42212 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42209,(1),null);
var map__42212__$1 = cljs.core.__destructure_map(map__42212);
var path = map__42212__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42212__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42212__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__4221__auto__ = path;
if(cljs.core.truth_(and__4221__auto__)){
return r;
} else {
...
var vec__42217 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42217,(0),null);
var map__42220 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42217,(1),null);
var map__42220__$1 = cljs.core.__destructure_map(map__42220);
var path = map__42220__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42220__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42220__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__4221__auto__ = path;
if(cljs.core.truth_(and__4221__auto__)){
return cljs.core.seq(l);
} else {
...
var vec__42221 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42221,(0),null);
var map__42224 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42221,(1),null);
var map__42224__$1 = cljs.core.__destructure_map(map__42224);
var path = map__42224__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42224__$1,new cljs.core.Keyword(null,"l","l",1395893423));
if((path == null)){
throw "Insert at top";
} else {
...
var map__42228 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42225,(1),null);
var map__42228__$1 = cljs.core.__destructure_map(map__42228);
var path = map__42228__$1;
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42228__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
throw "Insert at top";
} else {
...
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42229,(1),null);
...
var len__4829__auto___42246 = arguments.length;
var i__4830__auto___42247 = (0);
while(true){
if((i__4830__auto___42247 < len__4829__auto___42246)){
args__4835__auto__.push((arguments[i__4830__auto___42247]));

var G__42248 = (i__4830__auto___42247 + (1));
i__4830__auto___42247 = G__42248;
continue;
} else {
}
break;
...
/** @this {Function} */
(clojure.zip.edit.cljs$lang$applyTo = (function (seq42232){
...
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__42233,G__42234,seq42232__$2);
}));
...
var G__42252 = clojure.zip.rightmost(child);
loc__$1 = G__42252;
continue;
} else {
return loc__$1;
...
var vec__42235 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42235,(0),null);
...
var path = map__42238__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42238__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42238__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42238__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var rs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42238__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
throw "Remove at top";
} else {
...
var G__42255 = clojure.zip.rightmost(child);
loc__$1 = G__42255;
continue;
} else {
return loc__$1;
