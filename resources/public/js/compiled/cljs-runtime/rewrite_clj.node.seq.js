...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4474__auto__,k41953,else__4475__auto__){
var self__ = this;
var this__4474__auto____$1 = this;
var G__41961 = k41953;
var G__41961__$1 = (((G__41961 instanceof cljs.core.Keyword))?G__41961.fqn:null);
switch (G__41961__$1) {
case "tag":
return self__.tag;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k41953,else__4475__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4495__auto__,p__41962){
var vec__41963 = p__41962;
var k__4496__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41963,(0),null);
var v__4497__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41963,(1),null);
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__41952){
var self__ = this;
var G__41952__$1 = this;
return (new cljs.core.RecordIter((0),G__41952__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tag","tag",-1290361223),new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this41954,other41955){
var self__ = this;
var this41954__$1 = this;
return (((!((other41955 == null)))) && ((((this41954__$1.constructor === other41955.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this41954__$1.tag,other41955.tag)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this41954__$1.wrap_fn,other41955.wrap_fn)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this41954__$1.wrap_length,other41955.wrap_length)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this41954__$1.seq_fn,other41955.seq_fn)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this41954__$1.children,other41955.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this41954__$1.__extmap,other41955.__extmap)))))))))))))));
}));
...
var self__ = this;
var this$__$1 = this;
var G__41972 = rewrite_clj.node.protocols.sexprs(self__.children);
return (self__.seq_fn.cljs$core$IFn$_invoke$arity$1 ? self__.seq_fn.cljs$core$IFn$_invoke$arity$1(G__41972) : self__.seq_fn.call(null,G__41972));
}));
...
var self__ = this;
var this$__$1 = this;
var G__41973 = rewrite_clj.node.protocols.concat_strings(self__.children);
return (self__.wrap_fn.cljs$core$IFn$_invoke$arity$1 ? self__.wrap_fn.cljs$core$IFn$_invoke$arity$1(G__41973) : self__.wrap_fn.call(null,G__41973));
}));
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__4479__auto__,k41953){
var self__ = this;
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4480__auto__,k__4481__auto__,G__41952){
var self__ = this;
var this__4480__auto____$1 = this;
var pred__41982 = cljs.core.keyword_identical_QMARK_;
var expr__41983 = k__4481__auto__;
if(cljs.core.truth_((pred__41982.cljs$core$IFn$_invoke$arity$2 ? pred__41982.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__41983) : pred__41982.call(null,new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__41983)))){
return (new rewrite_clj.node.seq.SeqNode(G__41952,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__41982.cljs$core$IFn$_invoke$arity$2 ? pred__41982.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),expr__41983) : pred__41982.call(null,new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),expr__41983)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,G__41952,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__41982.cljs$core$IFn$_invoke$arity$2 ? pred__41982.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),expr__41983) : pred__41982.call(null,new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),expr__41983)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,G__41952,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__41982.cljs$core$IFn$_invoke$arity$2 ? pred__41982.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),expr__41983) : pred__41982.call(null,new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),expr__41983)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,G__41952,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__41982.cljs$core$IFn$_invoke$arity$2 ? pred__41982.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__41983) : pred__41982.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__41983)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,G__41952,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4481__auto__,G__41952),null));
}
}
}
}
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4471__auto__,G__41952){
var self__ = this;
var this__4471__auto____$1 = this;
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,G__41952,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.seq.map__GT_SeqNode = (function rewrite_clj$node$seq$map__GT_SeqNode(G__41956){
var extmap__4512__auto__ = (function (){var G__41991 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__41956,new cljs.core.Keyword(null,"tag","tag",-1290361223),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),new cljs.core.Keyword(null,"children","children",-940561982)], 0));
...
return (new rewrite_clj.node.seq.SeqNode(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(G__41956),new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130).cljs$core$IFn$_invoke$arity$1(G__41956),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519).cljs$core$IFn$_invoke$arity$1(G__41956),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231).cljs$core$IFn$_invoke$arity$1(G__41956),new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__41956),null,cljs.core.not_empty(extmap__4512__auto__),null));
});
...
return rewrite_clj.node.seq.__GT_SeqNode(new cljs.core.Keyword(null,"list","list",765357683),rewrite_clj.node.seq.wrap_list,(2),(function (p1__41993_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.list,p1__41993_SHARP_);
}),children);
});
/**
...
return rewrite_clj.node.seq.__GT_SeqNode(new cljs.core.Keyword(null,"map","map",1371690461),rewrite_clj.node.seq.wrap_map,(2),(function (p1__41994_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,p1__41994_SHARP_);
}),children);
});
