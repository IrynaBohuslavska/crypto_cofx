...
var len__4829__auto___32022 = arguments.length;
var i__4830__auto___32023 = (0);
while(true){
if((i__4830__auto___32023 < len__4829__auto___32022)){
args__4835__auto__.push((arguments[i__4830__auto___32023]));

var G__32024 = (i__4830__auto___32023 + (1));
i__4830__auto___32023 = G__32024;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq31846){
...
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__31847,G__31848,seq31846__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__31920_SHARP_){
return (!((cljs.core.meta(p1__31920_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31975__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e31976){var _e__30769__auto__ = e31976;
return false;
}})();
if(cljs.core.truth_(or__4223__auto__)){
return or__4223__auto__;
...
}catch (e31982){var _e__30769__auto__ = e31982;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__32001 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__32002 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__32002);

try{var map__32008 = opts;
var map__32008__$1 = cljs.core.__destructure_map(map__32008);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32008__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__32001);
}});
...
var temp__5751__auto___32058 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5751__auto___32058)){
var managed_print_level_32059 = temp__5751__auto___32058;
var _STAR_print_level_STAR__orig_val__32016_32060 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__32017_32061 = managed_print_level_32059;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__32017_32061);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__32011_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__32011_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__32016_32060);
}} else {
job_fn();
}
