...
var G__42371 = (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(n0) : f.call(null,n0));
var G__42371__$1 = (((G__42371 == null))?null:cljs.core.iterate((function (loc){
...
var G__42371__$2 = (((G__42371__$1 == null))?null:cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__42371__$1));
var G__42371__$3 = (((G__42371__$2 == null))?null:cljs.core.last(G__42371__$2));
if((G__42371__$3 == null)){
return null;
} else {
return rewrite_clj.zip.move.up(G__42371__$3);
}
} else {
return zloc;
}
...
var G__42374 = rewrite_clj.zip.move.right(v);
var G__42375 = rewrite_clj.zip.move.up(v);
loc = G__42374;
parent = G__42375;
continue;
} else {
var G__42376 = rewrite_clj.zip.move.right(v0);
var G__42377 = parent;
loc = G__42376;
parent = G__42377;
continue;
...
var G__42378 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(v));
var G__42379 = rewrite_clj.zip.move.up(v);
loc = G__42378;
parent = G__42379;
continue;
} else {
var G__42380 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(loc));
var G__42381 = parent;
loc = G__42380;
parent = G__42381;
continue;
...
if(rewrite_clj.zip.seqz.map_QMARK_(zloc)){
var G__42372 = zloc;
var G__42372__$1 = (((G__42372 == null))?null:rewrite_clj.zip.move.down(G__42372));
var G__42372__$2 = (((G__42372__$1 == null))?null:rewrite_clj.zip.findz.find_value.cljs$core$IFn$_invoke$arity$2(G__42372__$1,k));
if((G__42372__$2 == null)){
return null;
} else {
return rewrite_clj.zip.move.right(G__42372__$2);
}
} else {
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2((function (){var G__42373 = rewrite_clj.zip.move.down(zloc);
var G__42373__$1 = (((G__42373 == null))?null:cljs.core.iterate(rewrite_clj.zip.move.right,G__42373));
if((G__42373__$1 == null)){
return null;
} else {
return cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__42373__$1);
}
})(),k);
}
});
