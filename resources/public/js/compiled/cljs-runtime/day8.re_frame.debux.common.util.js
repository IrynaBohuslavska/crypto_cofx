...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (r,p__52091){
...
return clojure.zip.zipper((function (p1__52095_SHARP_){
return ((cljs.core.sequential_QMARK_(p1__52095_SHARP_)) || (cljs.core.map_QMARK_(p1__52095_SHARP_)));
}),(function (x){
...
if(cljs.core.map_QMARK_(x)){
return cljs.core.with_meta(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (r,p__52097){
var vec__52098 = p__52097;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52098,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52098,(1),null);
...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__52106_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__52106_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52105_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__52105_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__52107_SHARP_){
return (((p1__52107_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__52107_SHARP_) == null)));
 ...
 */
day8.re_frame.debux.common.util.with_symbols_names = (function day8$re_frame$debux$common$util$with_symbols_names(form,p__52111,mapping){
var map__52112 = p__52111;
var map__52112__$1 = cljs.core.__destructure_map(map__52112);
var state = map__52112__$1;
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52112__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52112__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52112__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__52110_SHARP_){
var and__4221__auto__ = (p1__52110_SHARP_ instanceof cljs.core.Symbol);
if(and__4221__auto__){
return cljs.core.namespace(p1__52110_SHARP_);
} else {
...
var G__52203 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__52206 = clojure.zip.next(loc);
loc = G__52206;
continue;
}
}
...
var len__4829__auto___52211 = arguments.length;
var i__4830__auto___52212 = (0);
while(true){
if((i__4830__auto___52212 < len__4829__auto___52211)){
args__4835__auto__.push((arguments[i__4830__auto___52212]));

var G__52213 = (i__4830__auto___52212 + (1));
i__4830__auto___52212 = G__52213;
continue;
} else {
}
break;
...
(day8.re_frame.debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__52137){
var vec__52138 = p__52137;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52138,(0),null);
...
/** @this {Function} */
(day8.re_frame.debux.common.util.form_header.cljs$lang$applyTo = (function (seq52131){
var G__52132 = cljs.core.first(seq52131);
var seq52131__$1 = cljs.core.next(seq52131);
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__52132,seq52131__$1);
}));

day8.re_frame.debux.common.util.prepend_blanks = (function day8$re_frame$debux$common$util$prepend_blanks(lines){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__52142_SHARP_){
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__52142_SHARP_)].join('');
}),lines);
});
...
var _STAR_print_newline_STAR__orig_val__52147_52222 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__52148_52223 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__52149_52224 = true;
var _STAR_print_fn_STAR__temp_val__52150_52225 = (function (x__4761__auto__){
return sb__4760__auto__.append(x__4761__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__52149_52224);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__52150_52225);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__52148_52223);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__52147_52222);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4760__auto__);
})();
var pprint = clojure.string.trim(result__$1);
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__52143_SHARP_){
return day8.re_frame.debux.common.util.prepend_bars(p1__52143_SHARP_,indent_level);
...
if(typeof f === 'number'){
var G__52228 = cljs.core.next(opts__$1);
var G__52229 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__52228;
acc = G__52229;
continue;
} else {
if(typeof f === 'string'){
var G__52231 = cljs.core.next(opts__$1);
var G__52232 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__52231;
acc = G__52232;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"if","if",-458814265))){
var G__52233 = cljs.core.nnext(opts__$1);
var G__52234 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__52233;
acc = G__52234;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"js","js",1768080579))){
var G__52235 = cljs.core.next(opts__$1);
var G__52236 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__52235;
acc = G__52236;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__52155 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
return (fexpr__52155.cljs$core$IFn$_invoke$arity$1 ? fexpr__52155.cljs$core$IFn$_invoke$arity$1(f) : fexpr__52155.call(null,f));
})())){
var G__52238 = cljs.core.next(opts__$1);
var G__52239 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__52238;
acc = G__52239;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__52156 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),null,new cljs.core.Keyword(null,"style","style",-496642736),null], null), null);
return (fexpr__52156.cljs$core$IFn$_invoke$arity$1 ? fexpr__52156.cljs$core$IFn$_invoke$arity$1(f) : fexpr__52156.call(null,f));
})())){
var G__52240 = cljs.core.nnext(opts__$1);
var G__52241 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__52240;
acc = G__52241;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"clog","clog",954273629))){
var G__52242 = cljs.core.next(opts__$1);
var G__52243 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__52242;
acc = G__52243;
continue;
} else {
...
day8.re_frame.debux.common.util.quote_val = (function day8$re_frame$debux$common$util$quote_val(p__52157){
...
var G__52163 = new cljs.core.Symbol(null,"recur","recur",1202958259,null);
var fexpr__52162 = cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.set,cljs.core.flatten)(form);
return (fexpr__52162.cljs$core$IFn$_invoke$arity$1 ? fexpr__52162.cljs$core$IFn$_invoke$arity$1(G__52163) : fexpr__52162.call(null,G__52163));
});
...
day8.re_frame.debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__52166 = quoted_form;
var G__52167 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__52166,G__52167) : day8.re_frame.debux.common.util.remove_d.call(null,G__52166,G__52167));
...
day8.re_frame.debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__52169 = quoted_form;
var G__52170 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__52169,G__52170) : day8.re_frame.debux.common.util.remove_d.call(null,G__52169,G__52170));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
return (function() { 
var G__52244__delegate = function (arg){
...
day8.re_frame.debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__52171 = quoted_form;
var G__52172 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__52171,G__52172) : day8.re_frame.debux.common.util.remove_d.call(null,G__52171,G__52172));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
while (G__52245__i < G__52245__a.length) {G__52245__a[G__52245__i] = arguments[G__52245__i + 0]; ++G__52245__i;}
  arg = new cljs.core.IndexedSeq(G__52245__a,0,null);
} 
return G__52244__delegate.call(this,arg);};
G__52244.cljs$lang$maxFixedArity = 0;
G__52244.cljs$lang$applyTo = (function (arglist__52246){
var arg = cljs.core.seq(arglist__52246);
return G__52244__delegate(arg);
});
...
var G__52247 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__52247;
continue;
} else {
...
var G__52248 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__52248;
continue;
} else {
var G__52249 = clojure.zip.next(loc);
loc = G__52249;
continue;
