...
var o31417 = temp__5751__auto__;
var temp__5751__auto____$1 = (o31417["core"]);
if(cljs.core.truth_(temp__5751__auto____$1)){
var o31418 = temp__5751__auto____$1;
return (o31418["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__30762__auto__ = f;
return (o__30762__auto__["toString"]).call(o__30762__auto__);
} else {
return "";
}
}catch (e31431){var _ = e31431;
return "";
}});
...
try{var o__30762__auto___31776 = t;
(o__30762__auto___31776["cljs$lang$ctorPrWriter"]).call(o__30762__auto___31776,t,writer);
}catch (e31447){var __31777 = e31447;
}
...
var char_code = (function (){var o__30762__auto__ = (new String(char$));
return (o__30762__auto__["charCodeAt"]).call(o__30762__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__30762__auto__ = String;
return (o__30762__auto__["fromCharCode"]).call(o__30762__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__31461 = num_code;
switch (G__31461) {
case (1):
return (185);
...
var o__30762__auto__ = String;
return (o__30762__auto__["fromCharCode"]).call(o__30762__auto__,superscript_code);
});
/**
...
}catch (e31482){var _e__30769__auto__ = e31482;
return false;
}})())){
...
var vec__31487 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31487,(0),null);
...
var len__4829__auto___31783 = arguments.length;
var i__4830__auto___31784 = (0);
while(true){
if((i__4830__auto___31784 < len__4829__auto___31783)){
args__4835__auto__.push((arguments[i__4830__auto___31784]));

var G__31786 = (i__4830__auto___31784 + (1));
i__4830__auto___31784 = G__31786;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__31514){
var vec__31515 = p__31514;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31515,(0),null);
...
var G__31790 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__31791 = cljs.core.butlast(remaining_tokens);
name_tokens = G__31790;
remaining_tokens = G__31791;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq31512){
var G__31513 = cljs.core.first(seq31512);
var seq31512__$1 = cljs.core.next(seq31512);
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__31513,seq31512__$1);
}));
...
var vec__31540 = cljs.core.split_with((function (p1__31536_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__31536_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31540,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31540,(1),null);
...
var vec__31562 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31562,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31562,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__31805 = cljs.core.rest(remaining_tokens);
var G__31806 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__31805;
name_tokens = G__31806;
continue;
} else {
...
var vec__31593 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31593,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31593,(1),null);
var vec__31596 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31596,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31596,(1),null);
var vec__31599 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31599,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31599,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31599,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31599,(3),null);
...
var vec__31612 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31612,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31612,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31612,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31612,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31612,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31612,(5),null);
...
if(cljs.core.truth_(temp__5751__auto__)){
var vec__31621 = temp__5751__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31621,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31621,(1),null);
var vec__31626 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31626,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31626,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__31631 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__31631) : devtools.munging.parse_fn_info_deep.call(null,G__31631));
})()));
}
} else {
return fn_info;
...
var G__31817 = (arity + (1));
var G__31818 = (function (){var temp__5751__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5751__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__31647){
var vec__31648 = p__31647;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31648,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31648,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__31659_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__31659_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__31660_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__31660_SHARP_);
}),sorted_infos);
...
var args__4835__auto__ = [];
var len__4829__auto___31828 = arguments.length;
var i__4830__auto___31829 = (0);
while(true){
if((i__4830__auto___31829 < len__4829__auto___31828)){
args__4835__auto__.push((arguments[i__4830__auto___31829]));

var G__31830 = (i__4830__auto___31829 + (1));
i__4830__auto___31829 = G__31830;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__31664){
var vec__31665 = p__31664;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31665,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq31662){
var G__31663 = cljs.core.first(seq31662);
var seq31662__$1 = cljs.core.next(seq31662);
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__31663,seq31662__$1);
}));
...
var map__31696 = options;
var map__31696__$1 = cljs.core.__destructure_map(map__31696);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31696__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31696__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31696__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31696__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__31697 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31697,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31697,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31697,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31697,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31697,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31697,(5),null);
...
var o__30762__auto__ = f;
return (o__30762__auto__["getBasis"]).call(o__30762__auto__);
});
/**
...
}catch (e31719){var _e__30769__auto__ = e31719;
...
var G__31833 = (obj[cljs.core.first(path)]);
var G__31834 = cljs.core.rest(path);
obj = G__31833;
path = G__31834;
continue;
} else {
...
var _STAR_ = (function (accum,p__31757){
var vec__31758 = p__31757;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31758,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31758,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__31764){
var vec__31765 = p__31764;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31765,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31765,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31765,(2),null);
...
var post_process = (function (p__31769){
var vec__31770 = p__31769;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31770,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31770,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__31768_SHARP_){
return (obj[cljs.core.first(p1__31768_SHARP_)]);
}),sorted_matches);
