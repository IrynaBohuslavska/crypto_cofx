...
(rewrite_clj.node.whitespace.WhitespaceNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4474__auto__,k41355,else__4475__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k41355,else__4475__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4495__auto__,p__41367){
var vec__41368 = p__41367;
var k__4496__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41368,(0),null);
var v__4497__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41368,(1),null);
...
(rewrite_clj.node.whitespace.WhitespaceNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__41354){
var self__ = this;
var G__41354__$1 = this;
return (new cljs.core.RecordIter((0),G__41354__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"whitespace","whitespace",-1340035483)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.whitespace.WhitespaceNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this41356,other41357){
var self__ = this;
var this41356__$1 = this;
return (((!((other41357 == null)))) && ((((this41356__$1.constructor === other41357.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this41356__$1.whitespace,other41357.whitespace)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this41356__$1.__extmap,other41357.__extmap)))))));
}));
...
(rewrite_clj.node.whitespace.WhitespaceNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__4479__auto__,k41355){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k41355);

}
}));

(rewrite_clj.node.whitespace.WhitespaceNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4480__auto__,k__4481__auto__,G__41354){
var self__ = this;
var this__4480__auto____$1 = this;
var pred__41420 = cljs.core.keyword_identical_QMARK_;
var expr__41421 = k__4481__auto__;
if(cljs.core.truth_((pred__41420.cljs$core$IFn$_invoke$arity$2 ? pred__41420.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"whitespace","whitespace",-1340035483),expr__41421) : pred__41420.call(null,new cljs.core.Keyword(null,"whitespace","whitespace",-1340035483),expr__41421)))){
return (new rewrite_clj.node.whitespace.WhitespaceNode(G__41354,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.whitespace.WhitespaceNode(self__.whitespace,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4481__auto__,G__41354),null));
}
}));
...
(rewrite_clj.node.whitespace.WhitespaceNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4471__auto__,G__41354){
var self__ = this;
var this__4471__auto____$1 = this;
return (new rewrite_clj.node.whitespace.WhitespaceNode(self__.whitespace,G__41354,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.whitespace.map__GT_WhitespaceNode = (function rewrite_clj$node$whitespace$map__GT_WhitespaceNode(G__41363){
var extmap__4512__auto__ = (function (){var G__41423 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__41363,new cljs.core.Keyword(null,"whitespace","whitespace",-1340035483));
if(cljs.core.record_QMARK_(G__41363)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__41423);
} else {
return G__41423;
}
})();
return (new rewrite_clj.node.whitespace.WhitespaceNode(new cljs.core.Keyword(null,"whitespace","whitespace",-1340035483).cljs$core$IFn$_invoke$arity$1(G__41363),null,cljs.core.not_empty(extmap__4512__auto__),null));
});
...
(rewrite_clj.node.whitespace.NewlineNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4474__auto__,k41425,else__4475__auto__){
var self__ = this;
var this__4474__auto____$1 = this;
var G__41429 = k41425;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k41425,else__4475__auto__);
...
var self__ = this;
var this__4492__auto____$1 = this;
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4495__auto__,p__41430){
var vec__41431 = p__41430;
var k__4496__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41431,(0),null);
var v__4497__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41431,(1),null);
return (f__4493__auto__.cljs$core$IFn$_invoke$arity$3 ? f__4493__auto__.cljs$core$IFn$_invoke$arity$3(ret__4495__auto__,k__4496__auto__,v__4497__auto__) : f__4493__auto__.call(null,ret__4495__auto__,k__4496__auto__,v__4497__auto__));
}),init__4494__auto__,this__4492__auto____$1);
}));
...
(rewrite_clj.node.whitespace.NewlineNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__41424){
var self__ = this;
var G__41424__$1 = this;
return (new cljs.core.RecordIter((0),G__41424__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"newlines","newlines",-1185451518)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.whitespace.NewlineNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this41426,other41427){
var self__ = this;
var this41426__$1 = this;
return (((!((other41427 == null)))) && ((((this41426__$1.constructor === other41427.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this41426__$1.newlines,other41427.newlines)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this41426__$1.__extmap,other41427.__extmap)))))));
}));
...
(rewrite_clj.node.whitespace.NewlineNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__4479__auto__,k41425){
var self__ = this;
var this__4479__auto____$1 = this;
var G__41449 = k41425;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k41425);

}
}));

(rewrite_clj.node.whitespace.NewlineNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4480__auto__,k__4481__auto__,G__41424){
var self__ = this;
var this__4480__auto____$1 = this;
var pred__41450 = cljs.core.keyword_identical_QMARK_;
var expr__41451 = k__4481__auto__;
if(cljs.core.truth_((pred__41450.cljs$core$IFn$_invoke$arity$2 ? pred__41450.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"newlines","newlines",-1185451518),expr__41451) : pred__41450.call(null,new cljs.core.Keyword(null,"newlines","newlines",-1185451518),expr__41451)))){
return (new rewrite_clj.node.whitespace.NewlineNode(G__41424,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.whitespace.NewlineNode(self__.newlines,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4481__auto__,G__41424),null));
}
}));
...
(rewrite_clj.node.whitespace.NewlineNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4471__auto__,G__41424){
var self__ = this;
var this__4471__auto____$1 = this;
return (new rewrite_clj.node.whitespace.NewlineNode(self__.newlines,G__41424,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.whitespace.map__GT_NewlineNode = (function rewrite_clj$node$whitespace$map__GT_NewlineNode(G__41428){
var extmap__4512__auto__ = (function (){var G__41453 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__41428,new cljs.core.Keyword(null,"newlines","newlines",-1185451518));
if(cljs.core.record_QMARK_(G__41428)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__41453);
} else {
return G__41453;
}
})();
return (new rewrite_clj.node.whitespace.NewlineNode(new cljs.core.Keyword(null,"newlines","newlines",-1185451518).cljs$core$IFn$_invoke$arity$1(G__41428),null,cljs.core.not_empty(extmap__4512__auto__),null));
});
...
var comma_41475 = rewrite_clj.node.whitespace.whitespace_node(", ");
/**
...
return cljs.core.butlast(cljs.core.interleave.cljs$core$IFn$_invoke$arity$2(nodes,cljs.core.repeat.cljs$core$IFn$_invoke$arity$1(comma_41475)));
});
var nl_41476 = rewrite_clj.node.whitespace.newline_node("\n");
/**
...
return cljs.core.butlast(cljs.core.interleave.cljs$core$IFn$_invoke$arity$2(nodes,cljs.core.repeat.cljs$core$IFn$_invoke$arity$1(nl_41476)));
});
var space_41477 = rewrite_clj.node.whitespace.whitespace_node(" ");
/**
 * Interleave the given seq of nodes with `" "` nodes.
 */
rewrite_clj.node.whitespace.space_separated = (function rewrite_clj$node$whitespace$space_separated(nodes){
return cljs.core.butlast(cljs.core.interleave.cljs$core$IFn$_invoke$arity$2(nodes,cljs.core.repeat.cljs$core$IFn$_invoke$arity$1(space_41477)));
});
/**
