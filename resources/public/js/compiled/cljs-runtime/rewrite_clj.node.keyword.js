...
(rewrite_clj.node.keyword.KeywordNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4474__auto__,k41038,else__4475__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k41038,else__4475__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4495__auto__,p__41068){
var vec__41069 = p__41068;
var k__4496__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41069,(0),null);
var v__4497__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41069,(1),null);
...
(rewrite_clj.node.keyword.KeywordNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__41037){
var self__ = this;
var G__41037__$1 = this;
return (new cljs.core.RecordIter((0),G__41037__$1,2,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"k","k",-2146297393),new cljs.core.Keyword(null,"namespaced?","namespaced?",-877312877)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.keyword.KeywordNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this41039,other41040){
var self__ = this;
var this41039__$1 = this;
return (((!((other41040 == null)))) && ((((this41039__$1.constructor === other41040.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this41039__$1.k,other41040.k)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this41039__$1.namespaced_QMARK_,other41040.namespaced_QMARK_)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this41039__$1.__extmap,other41040.__extmap)))))))));
}));
...
(rewrite_clj.node.keyword.KeywordNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__4479__auto__,k41038){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k41038);

}
}));

(rewrite_clj.node.keyword.KeywordNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4480__auto__,k__4481__auto__,G__41037){
var self__ = this;
var this__4480__auto____$1 = this;
var pred__41117 = cljs.core.keyword_identical_QMARK_;
var expr__41118 = k__4481__auto__;
if(cljs.core.truth_((pred__41117.cljs$core$IFn$_invoke$arity$2 ? pred__41117.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"k","k",-2146297393),expr__41118) : pred__41117.call(null,new cljs.core.Keyword(null,"k","k",-2146297393),expr__41118)))){
return (new rewrite_clj.node.keyword.KeywordNode(G__41037,self__.namespaced_QMARK_,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__41117.cljs$core$IFn$_invoke$arity$2 ? pred__41117.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"namespaced?","namespaced?",-877312877),expr__41118) : pred__41117.call(null,new cljs.core.Keyword(null,"namespaced?","namespaced?",-877312877),expr__41118)))){
return (new rewrite_clj.node.keyword.KeywordNode(self__.k,G__41037,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.keyword.KeywordNode(self__.k,self__.namespaced_QMARK_,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4481__auto__,G__41037),null));
}
}
}));
...
(rewrite_clj.node.keyword.KeywordNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4471__auto__,G__41037){
var self__ = this;
var this__4471__auto____$1 = this;
return (new rewrite_clj.node.keyword.KeywordNode(self__.k,self__.namespaced_QMARK_,G__41037,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.keyword.map__GT_KeywordNode = (function rewrite_clj$node$keyword$map__GT_KeywordNode(G__41042){
var extmap__4512__auto__ = (function (){var G__41125 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__41042,new cljs.core.Keyword(null,"k","k",-2146297393),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"namespaced?","namespaced?",-877312877)], 0));
if(cljs.core.record_QMARK_(G__41042)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__41125);
} else {
return G__41125;
}
})();
return (new rewrite_clj.node.keyword.KeywordNode(new cljs.core.Keyword(null,"k","k",-2146297393).cljs$core$IFn$_invoke$arity$1(G__41042),new cljs.core.Keyword(null,"namespaced?","namespaced?",-877312877).cljs$core$IFn$_invoke$arity$1(G__41042),null,cljs.core.not_empty(extmap__4512__auto__),null));
});
...
var len__4829__auto___41137 = arguments.length;
var i__4830__auto___41138 = (0);
while(true){
if((i__4830__auto___41138 < len__4829__auto___41137)){
args__4835__auto__.push((arguments[i__4830__auto___41138]));

var G__41139 = (i__4830__auto___41138 + (1));
i__4830__auto___41138 = G__41139;
continue;
} else {
}
break;
...
(rewrite_clj.node.keyword.keyword_node.cljs$core$IFn$_invoke$arity$variadic = (function (k,p__41130){
var vec__41131 = p__41130;
var namespaced_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41131,(0),null);
...
/** @this {Function} */
(rewrite_clj.node.keyword.keyword_node.cljs$lang$applyTo = (function (seq41126){
var G__41127 = cljs.core.first(seq41126);
var seq41126__$1 = cljs.core.next(seq41126);
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41127,seq41126__$1);
}));
