...
var i_45010 = (self__.level + (1));
while(true){
if((i_45010 <= (new_level + (1)))){
(update[i_45010] = self__.header);

var G__45011 = (i_45010 + (1));
i_45010 = G__45011;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_45012 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_45012[i]));
} else {
x__$2.forward.push((((i < links_45012.length))?(links_45012[i]):null));
}

if((i < links_45012.length)){
(links_45012[i] = x__$2);
} else {
links_45012.push(x__$2);
}
...
var i_45014 = (0);
while(true){
if((i_45014 <= self__.level)){
var links_45015 = (update[i_45014]).forward;
if((x__$1 === (((i_45014 < links_45015.length))?(links_45015[i_45014]):null))){
(links_45015[i_45014] = (x__$1.forward[i_45014]));

var G__45016 = (i_45014 + (1));
i_45014 = G__45016;
continue;
} else {
var G__45017 = (i_45014 + (1));
i_45014 = G__45017;
continue;
}
} else {
...
var G__45019 = nx;
var G__45020 = (level__$1 - (1));
x = G__45019;
level__$1 = G__45020;
continue;
} else {
var G__45021 = x;
var G__45022 = (level__$1 - (1));
x = G__45021;
level__$1 = G__45022;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__45024 = nx;
var G__45025 = (level__$1 - (1));
x = G__45024;
level__$1 = G__45025;
continue;
} else {
var G__45026 = x;
var G__45027 = (level__$1 - (1));
x = G__45026;
level__$1 = G__45027;
continue;
}
