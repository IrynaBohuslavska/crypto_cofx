...
var vec__43852 = (cljs.core.truth_(new cljs.core.Keyword(null,"zipper?","zipper?",-1061271842).cljs$core$IFn$_invoke$arity$1(options))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [coll,options], null):(cljs.core.truth_(new cljs.core.Keyword(null,"parse-string?","parse-string?",2006674325).cljs$core$IFn$_invoke$arity$1(options))?((typeof coll === 'string')?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [zprint.core.get_zipper(options,coll),options], null):(function(){throw (new Error(["Collection is not a string yet"," :parse-string? specified!"].join('')))})()):(cljs.core.truth_(new cljs.core.Keyword(null,"zloc?","zloc?",-1457193855).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"focus","focus",234677911).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"output","output",-1105869043).cljs$core$IFn$_invoke$arity$1(options))))?(function (){var vec__43859 = zprint.zutil.find_root_and_path_nw(coll);
var root = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43859,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43859,(1),null);
...
var input = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43852,(0),null);
var options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43852,(1),null);
 ...
 */
zprint.core.process_rest_options = (function zprint$core$process_rest_options(internal_options,p__43862){
var vec__43863 = p__43862;
var width_or_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43863,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43863,(1),null);
...
var width_or_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43870,(0),null);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43870,(1),null);
...
var vec__43885 = zprint.config.perform_remove(null,null,zprint.config.get_options(),rest_options);
var internal_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43885,(0),null);
var rest_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43885,(1),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43885,(2),null);
var vec__43888 = zprint.config.apply_style(null,null,internal_map,rest_options__$1);
var updated_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43888,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43888,(1),null);
var style_errors = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43888,(2),null);
 ...
 */
zprint.core.range_vec = (function zprint$core$range_vec(v,p__43904){
var vec__43905 = p__43904;
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43905,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43905,(1),null);
...
var vec__43908 = tuple;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43908,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43908,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43908,(2),null);
...
var vec__43922 = cljs.core.first(style_vec);
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43922,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43922,(1),null);
var e = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43922,(2),null);
var tuple = vec__43922;
...
var G__44045 = cljs.core.next(style_vec);
var G__44046 = ends_w_blanks_QMARK_;
var G__44047 = tuple;
var G__44048 = (cljs.core.truth_(add_previous_to_out_QMARK_)?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,previous_tuple):out);
style_vec = G__44045;
previous_ends_w_blanks_QMARK_ = G__44046;
previous_tuple = G__44047;
out = G__44048;
continue;
}
break;
...
var len__4829__auto___44049 = arguments.length;
var i__4830__auto___44050 = (0);
while(true){
if((i__4830__auto___44050 < len__4829__auto___44049)){
args__4835__auto__.push((arguments[i__4830__auto___44050]));

var G__44051 = (i__4830__auto___44050 + (1));
i__4830__auto___44050 = G__44051;
continue;
} else {
}
break;
...
var vec__43928 = zprint.core.process_rest_options(internal_options,rest);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43928,(0),null);
var rest_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43928,(1),null);
...
var result = (function (){var G__43931 = zprint.core.parse_string_all_options(rest_options);
var G__43932 = zprint.core.zprint_str_internal;
var G__43933 = ":parse-string-all? call";
var G__43934 = (function (){var G__43935 = rewrite_clj.parser.parse_string_all(coll);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__43935) : zprint.zutil.edn_STAR_.call(null,G__43935));
})();
return (zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4 ? zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4(G__43931,G__43932,G__43933,G__43934) : zprint.core.process_multiple_forms.call(null,G__43931,G__43932,G__43933,G__43934));
})();
if(cljs.core.truth_(new cljs.core.Keyword(null,"dbg?","dbg?",1845730771).cljs$core$IFn$_invoke$arity$1(rest_options))){
...
var vec__43936 = zprint.core.zprint_STAR_(coll,special_option,actual_options);
var cvec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43936,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43936,(1),null);
...
/** @this {Function} */
(zprint.core.zprint_str_internal.cljs$lang$applyTo = (function (seq43925){
...
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__43926,G__43927,seq43925__$2);
}));
...
var args__4835__auto__ = [];
var len__4829__auto___44064 = arguments.length;
var i__4830__auto___44065 = (0);
while(true){
if((i__4830__auto___44065 < len__4829__auto___44064)){
args__4835__auto__.push((arguments[i__4830__auto___44065]));

var G__44067 = (i__4830__auto___44065 + (1));
i__4830__auto___44065 = G__44067;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.zprint_str.cljs$lang$applyTo = (function (seq43940){
var G__43941 = cljs.core.first(seq43940);
var seq43940__$1 = cljs.core.next(seq43940);
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__43941,seq43940__$1);
}));
...
var args__4835__auto__ = [];
var len__4829__auto___44068 = arguments.length;
var i__4830__auto___44069 = (0);
while(true){
if((i__4830__auto___44069 < len__4829__auto___44068)){
args__4835__auto__.push((arguments[i__4830__auto___44069]));

var G__44070 = (i__4830__auto___44069 + (1));
i__4830__auto___44069 = G__44070;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.czprint_str.cljs$lang$applyTo = (function (seq43942){
var G__43943 = cljs.core.first(seq43942);
var seq43942__$1 = cljs.core.next(seq43942);
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__43943,seq43942__$1);
}));
...
/** @this {Function} */
(zprint.core.zprint.cljs$lang$applyTo = (function (seq43949){
var G__43950 = cljs.core.first(seq43949);
var seq43949__$1 = cljs.core.next(seq43949);
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__43950,seq43949__$1);
}));
...
var args__4835__auto__ = [];
var len__4829__auto___44078 = arguments.length;
var i__4830__auto___44079 = (0);
while(true){
if((i__4830__auto___44079 < len__4829__auto___44078)){
args__4835__auto__.push((arguments[i__4830__auto___44079]));

var G__44080 = (i__4830__auto___44079 + (1));
i__4830__auto___44079 = G__44080;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.czprint.cljs$lang$applyTo = (function (seq43959){
var G__43960 = cljs.core.first(seq43959);
var seq43959__$1 = cljs.core.next(seq43959);
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__43960,seq43959__$1);
}));
 ...
 */
zprint.core.process_form = (function zprint$core$process_form(rest_options,zprint_fn,zprint_specifier,p__43972,form){
var vec__43973 = p__43972;
var next_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43973,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43973,(1),null);
var indent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43973,(2),null);
var zprint_num = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43973,(3),null);
var comment_QMARK_ = zprint.zutil.zcomment_QMARK_(form);
var whitespace_form_QMARK_ = zprint.zutil.whitespace_QMARK_(form);
var vec__43976 = (cljs.core.truth_((function (){var and__4221__auto__ = comment_QMARK_;
if(cljs.core.truth_(and__4221__auto__)){
...
var new_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43976,(0),null);
var error_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43976,(1),null);
...
var G__44085 = cljs.core.next(sos);
var G__44086 = comment_QMARK_;
var G__44087 = (function (){var or__4223__auto__ = (!(empty_string_QMARK_));
if(or__4223__auto__){
return or__4223__auto__;
} else {
...
var G__44088 = ((empty_string_QMARK_)?out:((cljs.core.not(start_interpolating_QMARK_))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,s):(cljs.core.truth_(previous_comment_QMARK_)?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,"\n"),s):cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,interpose_str),s)
)));
sos = G__44085;
previous_comment_QMARK_ = G__44086;
start_interpolating_QMARK_ = G__44087;
out = G__44088;
continue;
}
break;
...
try{var vec__44000 = zprint.core.remove_shebang(file_str);
var shebang = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44000,(0),null);
var file_str__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44000,(1),null);
...
var vec__44003 = (cljs.core.truth_((function (){var or__4223__auto__ = range_start__$1;
if(cljs.core.truth_(or__4223__auto__)){
return or__4223__auto__;
} else {
return range_end__$1;
...
var actual_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44003,(0),null);
var actual_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44003,(1),null);
...
var vec__44006 = (cljs.core.truth_((function (){var and__4221__auto__ = actual_start;
if(cljs.core.truth_(and__4221__auto__)){
return actual_end;
} else {
return and__4221__auto__;
...
var before_lines = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44006,(0),null);
var range = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44006,(1),null);
var after_lines = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44006,(2),null);
...
var forms = (function (){var G__44009 = rewrite_clj.parser.parse_string_all(filestring__$1);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__44009) : zprint.zutil.edn_STAR_.call(null,G__44009));
})();
