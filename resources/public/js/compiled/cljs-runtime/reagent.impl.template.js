...
var G__38333 = o;
goog.object.set(G__38333,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__38351__delegate = function (args){
...
while (G__38352__i < G__38352__a.length) {G__38352__a[G__38352__i] = arguments[G__38352__i + 0]; ++G__38352__i;}
  args = new cljs.core.IndexedSeq(G__38352__a,0,null);
} 
return G__38351__delegate.call(this,args);};
...
return G__38351__delegate(args);
});
...
var G__38334 = o;
goog.object.set(G__38334,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__38354__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__38355__i < G__38355__a.length) {G__38355__a[G__38355__i] = arguments[G__38355__i + 0]; ++G__38355__i;}
  args = new cljs.core.IndexedSeq(G__38355__a,0,null);
} 
...
var G__38335 = props;
var G__38335__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__38335,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__38335);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__38335__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4223__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__38336 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__38336,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__38336;
}
})(),id_class);
...
var G__38337 = (cljs.core.count(argv) - first_child);
switch (G__38337) {
case (0):
...
var vec__38338 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38338,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38338,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38338,(2),null);
...
var temp__5757__auto___38368 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___38368 == null)){
} else {
var key_38369 = temp__5757__auto___38368;
(jsprops.key = key_38369);
}
...
var temp__5757__auto___38370 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___38370 == null)){
} else {
var key_38371 = temp__5757__auto___38370;
(jsprops.key = key_38371);
}
...
var temp__5757__auto___38377 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5757__auto___38377 == null)){
} else {
var key_38378 = temp__5757__auto___38377;
(jsprops.key = key_38378);
}
...
var temp__5757__auto___38384 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___38384 == null)){
} else {
var key_38385 = temp__5757__auto___38384;
(jsprops.key = key_38385);
}
...
var temp__5757__auto___38386 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___38386 == null)){
} else {
var key_38387 = temp__5757__auto___38386;
(jsprops.key = key_38387);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__38341_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__38341_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__38342 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38342,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38342,(1),null);
...
break;
default:
var G__38395 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__38396 = compiler;
v = G__38395;
compiler = G__38396;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template38348 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template38348 = (function (opts,id,fn_to_element,parse_fn,meta38349){
this.opts = opts;
this.id = id;
this.fn_to_element = fn_to_element;
this.parse_fn = parse_fn;
this.meta38349 = meta38349;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(reagent.impl.template.t_reagent$impl$template38348.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_38350,meta38349__$1){
var self__ = this;
var _38350__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template38348(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta38349__$1));
}));

(reagent.impl.template.t_reagent$impl$template38348.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_38350){
var self__ = this;
var _38350__$1 = this;
return self__.meta38349;
}));

(reagent.impl.template.t_reagent$impl$template38348.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template38348.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template38348.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template38348.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template38348.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template38348.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta38349","meta38349",-2135504625,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template38348.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template38348.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template38348");

(reagent.impl.template.t_reagent$impl$template38348.cljs$lang$ctorPrWriter = (function (this__4461__auto__,writer__4462__auto__,opt__4463__auto__){
return cljs.core._write(writer__4462__auto__,"reagent.impl.template/t_reagent$impl$template38348");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template38348.
 */
reagent.impl.template.__GT_t_reagent$impl$template38348 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template38348(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta38349){
return (new reagent.impl.template.t_reagent$impl$template38348(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta38349));
});

}

return (new reagent.impl.template.t_reagent$impl$template38348(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
