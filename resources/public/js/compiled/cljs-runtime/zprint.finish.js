...
zprint.finish.no_style_map = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"f","f",-1597136552),(function (p1__40628_SHARP_){
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__40628_SHARP_,new cljs.core.Keyword(null,"none","none",1333468478))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"reverse","reverse",-888455266)], null),p1__40628_SHARP_);
} else {
 ...
 */
zprint.finish.within_QMARK_ = (function zprint$finish$within_QMARK_(n,p__40629){
var vec__40630 = p__40629;
var low = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40630,(0),null);
var high = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40630,(1),null);
return (((n >= low)) && ((n <= high)));
});
/**
 ...
 */
zprint.finish.ground_color_to_style = (function zprint$finish$ground_color_to_style(p__40633,s,color,element,idx){
var map__40634 = p__40633;
var map__40634__$1 = cljs.core.__destructure_map(map__40634);
var style_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40634__$1,new cljs.core.Keyword(null,"style-map","style-map",1488693527));
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40634__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var select = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40634__$1,new cljs.core.Keyword(null,"select","select",1147833503));
...
var G__40637 = (function (){var or__4223__auto__ = color;
...
var fexpr__40636 = (function (){var G__40638 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(element,new cljs.core.Keyword(null,"cursor-element","cursor-element",-616791907)))?(function (){
...
return (style_map.cljs$core$IFn$_invoke$arity$1 ? style_map.cljs$core$IFn$_invoke$arity$1(G__40638) : style_map.call(null,G__40638));
})();
return (fexpr__40636.cljs$core$IFn$_invoke$arity$1 ? fexpr__40636.cljs$core$IFn$_invoke$arity$1(G__40637) : fexpr__40636.call(null,G__40637));
} else {
return null;
}
});
 ...
 */
zprint.finish.add_length = (function zprint$finish$add_length(p__40639){
var vec__40640 = p__40639;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40640,(0),null);
var style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40640,(1),null);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40640,(2),null);
 ...
 *   which are in focus.
 */
zprint.finish.gc_vec_to_style_vec = (function zprint$finish$gc_vec_to_style_vec(ctx,idx,p__40643){
var vec__40644 = p__40643;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40644,(0),null);
var keyword_color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40644,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40644,(2),null);
...
var vec__40650 = cljs.core.first(remaining_cvec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40650,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40650,(1),null);
var element_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40650,(2),null);
...
var G__40705 = cljs.core.next(remaining_cvec);
var G__40706 = new_idx;
var G__40707 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new_idx);
remaining_cvec = G__40705;
idx = G__40706;
out = G__40707;
continue;
}
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__40657,cursor_vec){
var vec__40658 = p__40657;
var focus_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40658,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40658,(1),null);
var focus_vec = vec__40658;
...
var vec__40661 = cljs.core.split_at(focus_start,gcw_vec);
var front = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40661,(0),null);
var back = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40661,(1),null);
 ...
 */
zprint.finish.color_style = (function zprint$finish$color_style(p__40664){
var vec__40665 = p__40664;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40665,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40665,(1),null);
if((color == null)){
return s;
} else {
...
(zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__40671,existing_count){
var vec__40672 = p__40671;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40672,(0),null);
var cursor = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40672,(1),null);
...
return cljs.core.filterv((function (p1__40668_SHARP_){
return (!(cljs.core.empty_QMARK_(cljs.core.first(p1__40668_SHARP_))));
...
var vec__40679 = cljs.core.first(cvec_nl);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40679,(0),null);
var where = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40679,(1),null);
var cvec_element = vec__40679;
if((cvec_element == null)){
var G__40716 = cljs.core.next(cvec_nl);
var G__40717 = (idx + (1));
var G__40718 = start;
var G__40719 = out;
cvec_nl = G__40716;
...
var G__40720 = cljs.core.next(cvec_nl);
var G__40721 = (idx + (1));
var G__40722 = idx;
var G__40723 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__40720;
idx = G__40721;
start = G__40722;
out = G__40723;
...
var G__40724 = cljs.core.next(cvec_nl);
var G__40725 = (idx + (1));
var G__40726 = (idx + (1));
var G__40727 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__40724;
idx = G__40725;
start = G__40726;
out = G__40727;
...
var G__40728 = cljs.core.next(cvec_nl);
var G__40729 = (idx + (1));
var G__40730 = idx;
var G__40731 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null)),cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx,idx], null)));
cvec_nl = G__40728;
idx = G__40729;
start = G__40730;
out = G__40731;
...
var G__40732 = cljs.core.next(cvec_nl);
var G__40733 = (idx + (1));
var G__40734 = start;
var G__40735 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,out,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__40732;
idx = G__40733;
start = G__40734;
out = G__40735;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__40683_SHARP_,p2__40682_SHARP_){
if(zprint.finish.within_QMARK_(idx,p2__40682_SHARP_)){
return cljs.core.reduced(p1__40683_SHARP_);
} else {
return (p1__40683_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__40685,p__40686){
var vec__40687 = p__40685;
var focus_begin = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40687,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40687,(1),null);
var vec__40690 = p__40686;
var before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40690,(0),null);
var after = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40690,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__40694,cvec,focus_vec){
var map__40695 = p__40694;
var map__40695__$1 = cljs.core.__destructure_map(map__40695);
var options = map__40695__$1;
var map__40696 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40695__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
var map__40696__$1 = cljs.core.__destructure_map(map__40696);
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40696__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40696__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40696__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
...
var path_vecs__$1 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__40693_SHARP_){
return zprint.finish.surround_focus(lines_to_cvec,p1__40693_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
}),path_vecs);
