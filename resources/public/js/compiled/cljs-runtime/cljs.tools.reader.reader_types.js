...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_36811 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_36811(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_36812 = (function (reader){
var x__4521__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_36812(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_36813 = (function (reader,ch){
var x__4521__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_36813(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_36814 = (function (reader){
var x__4521__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_36814(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_36815 = (function (reader){
var x__4521__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_36815(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_36816 = (function (reader){
var x__4521__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_36816(reader);
}
});
...
var G__36824 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__36825 = s.append(c);
c = G__36824;
s = G__36825;
continue;
}
