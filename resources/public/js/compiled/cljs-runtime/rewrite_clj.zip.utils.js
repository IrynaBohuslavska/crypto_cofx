...
rewrite_clj.zip.utils.update_in_path = (function rewrite_clj$zip$utils$update_in_path(p__42328,k,f){
var vec__42329 = p__42328;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42329,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42329,(1),null);
var loc = vec__42329;
...
var G__42346 = clojure.zip.remove(zloc__$1);
zloc__$1 = G__42346;
continue;
}
break;
...
var G__42347 = rewrite_clj.zip.utils.remove_right(zloc__$1);
zloc__$1 = G__42347;
continue;
} else {
return zloc__$1;
...
var G__42348 = rewrite_clj.zip.utils.remove_left(zloc__$1);
zloc__$1 = G__42348;
continue;
} else {
return zloc__$1;
 ...
 */
rewrite_clj.zip.utils.remove_and_move_left = (function rewrite_clj$zip$utils$remove_and_move_left(p__42332){
var vec__42333 = p__42332;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42333,(0),null);
var map__42336 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42333,(1),null);
var map__42336__$1 = cljs.core.__destructure_map(map__42336);
var path = map__42336__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42336__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var loc = vec__42333;
if(cljs.core.seq(l)){
 ...
 * location, returns `nil`.
 */
rewrite_clj.zip.utils.remove_and_move_right = (function rewrite_clj$zip$utils$remove_and_move_right(p__42337){
var vec__42338 = p__42337;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42338,(0),null);
var map__42341 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42338,(1),null);
var map__42341__$1 = cljs.core.__destructure_map(map__42341);
var path = map__42341__$1;
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42341__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var loc = vec__42338;
if(cljs.core.seq(r)){
